  ...
  return (
    <div id="strativy-brain-panel" className="grid grid-cols-1 lg:grid-cols-12 gap-6 text-left">
      <div id="presets-sidebar-column" className="lg:col-span-4 space-y-4">
        <div>
          <h4 className="text-xs font-black text-zinc-500 dark:text-zinc-400 uppercase tracking-widest font-mono">
            Board Preset Scenarios
          </h4>
        ...
        <div className="space-y-3">
          {presets.map((preset, idx) => (
            ...
            >
              <div
                className={`flex justify-between items-center font-bold font-mono ${preset.color}`}
              >
                <span>{preset.title}</span>
                <ChevronRight className="w-3.5 h-3.5" />
              </div>
              <p className="text-[10px] text-zinc-500 dark:text-zinc-400 mt-1.5 line-clamp-2 leading-normal font-mono">
                {preset.prompt}
              </p>
            </button>
          ))}
      ...
      <div id="brain-dialog-console" className="lg:col-span-8 flex flex-col justify-between space-y-4">
        <div className="space-y-2">
          <label
            ...
            className="text-xs font-black text-zinc-500 dark:text-zinc-400 uppercase tracking-widest font-mono block"
          >
            Custom Board query
          </label>
          <textarea
        ...
        <div
          className={`p-5 rounded-2xl border min-h-[220px] text-xs leading-relaxed flex flex-col justify-between transition-all duration-300 ${
        ...
        >
          {loading ? (
            <div className="flex flex-col items-center justify-center space-y-3 py-14">
              ...
              <p className="text-xs text-zinc-500 dark:text-zinc-400 font-mono text-center max-w-md leading-relaxed">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center pb-2 border-b border-zinc-800/20">
                <span className="font-extrabold uppercase tracking-widest text-[9px] text-blue-500 font-mono">
